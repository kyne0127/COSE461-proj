...
python scripts/record_scenario.py \
    ...
    --out-dir data-evaluation-v4 \
    --manifest-path dataset/manifest_eval-v4.jsonl \
    --append-manifest
```
...
python scripts/record_scenario.py \
    ...
    --out-dir data-evaluation-v4 \
    --manifest-path dataset/manifest_eval-v4.jsonl --append-manifest
```
...
```bash
# Validate manifest
python src/evaluate.py dataset/manifest_eval-v4.jsonl --validate-only --check-images

# Run full evaluation
python src/evaluate.py dataset/manifest_eval-v4.jsonl \
